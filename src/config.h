...
#define PIXELPAPER_DIR "/.pixelpaper"
#define PIXELPAPER_CACHE_DIR PIXELPAPER_DIR "/cache"
#define PIXELPAPER_SETTINGS_FILE PIXELPAPER_DIR "/settings.bin"
#define PIXELPAPER_STATE_FILE PIXELPAPER_DIR "/state.bin"
#define PIXELPAPER_WIFI_FILE PIXELPAPER_DIR "/wifi.bin"
