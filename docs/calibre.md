...
This guide explains how to use the **Calibre Wireless Device** feature to send books directly from Calibre to your Pixelpaper Reader over WiFi.
...
- Your Pixelpaper Reader device
- Both devices connected to the **same WiFi network**

---

## Step 1: Enable Wireless Device in Pixelpaper
...
4. Once connected, the screen displays:
   ...
   - **Device Name** (e.g., "Pixelpaper Reader")
...
Calibre will automatically scan for wireless devices on your network. Your Pixelpaper Reader should appear in the device list within a few seconds.
...
3. Enter the IP address shown on your Pixelpaper (e.g., `192.168.1.42`)
4. Enter the port number (default: `9090`)

### Connection Confirmation

When connected:
- Your Pixelpaper screen changes to "Connected to Calibre"
...
While transferring:
- Pixelpaper shows "Receiving book..." with the title
...
- **Device** section with your Pixelpaper Reader
...
The book is deleted from your Pixelpaper's SD card.
...
```ini
[Settings]
device_name = Pixelpaper Reader
password =
```

### Available Settings

- **device_name** - How your device appears in Calibre (default: `Pixelpaper Reader`)
...
**Problem:** Calibre doesn't discover your Pixelpaper Reader
...
Pixelpaper implements the **Calibre Smart Device App** protocol:
...
2. On your Pixelpaper, press the **Back** button
