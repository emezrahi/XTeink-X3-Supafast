...
This guide explains how to connect your Pixelpaper Reader to WiFi and use the built-in web server to upload books from your computer or phone.

## Overview

Pixelpaper Reader includes a built-in web server that allows you to:
...
1. Ensure your computer is connected to the **same WiFi network** as your Pixelpaper Reader
...
1. Ensure your phone/tablet is connected to the **same WiFi network** as your Pixelpaper Reader
...
1. Verify both devices are on the **same WiFi network**
   ...
   - Confirm the Pixelpaper Reader shows "Connected" status
...
1. Press the **Back** button on your Pixelpaper Reader
