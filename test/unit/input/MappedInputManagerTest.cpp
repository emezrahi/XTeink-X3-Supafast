...
int mapButton(Button button, pixelpaper::Settings* settings) {
  const auto frontLayout = settings ? static_cast<pixelpaper::Settings::FrontButtonLayout>(settings->frontButtonLayout)
                                    : pixelpaper::Settings::FrontBCLR;
  const auto sideLayout = settings ? static_cast<pixelpaper::Settings::SideButtonLayout>(settings->sideButtonLayout)
...
int main() {
  ...
  // === Front button mapping: BCLR (default) ===
  {
    ...
    settings.frontButtonLayout = pixelpaper::Settings::FrontBCLR;
  ...
  {
    pixelpaper::Settings settings;
    settings.frontButtonLayout = pixelpaper::Settings::FrontLRBC;
  ...
  {
    pixelpaper::Settings settings;
    settings.sideButtonLayout = pixelpaper::Settings::PrevNext;
  ...
  {
    pixelpaper::Settings settings;
    settings.sideButtonLayout = pixelpaper::Settings::NextPrev;
