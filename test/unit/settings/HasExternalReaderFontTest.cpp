...
int main() {
  ...
  {
    pixelpaper::Settings settings;
    runner.expectEq(uint8_t(pixelpaper::Settings::FontMedium), settings.fontSize, "default fontSize is FontMedium");
  }
