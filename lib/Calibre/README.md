...
This library enables wireless book synchronization between Pixelpaper e-reader devices and Calibre (https://calibre-ebook.com/). It implements the "Smart Device" protocol that Calibre uses to communicate with compatible devices over WiFi.
...
```json
{
  ...
  "ccVersionNumber": 128,
  "coverHeight": 240,
  "deviceKind": "Pixelpaper E-Ink Reader",
  "deviceName": "My Pixelpaper",
...
**Device Simulator** - Simulates a Pixelpaper device connecting to real Calibre:
```bash
