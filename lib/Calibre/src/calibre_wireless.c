...
void calibre_device_config_init(calibre_device_config_t* config) {
  ...
  calibre_strlcpy(config->device_name, "Pixelpaper Reader", sizeof(config->device_name));
  calibre_strlcpy(config->manufacturer, "Pixelpaper", sizeof(config->manufacturer));
