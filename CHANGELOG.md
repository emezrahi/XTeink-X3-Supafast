...
> Project lineage note: Pixelpaper is a continuation of earlier community firmware work for the Xteink X4. This changelog tracks ongoing Pixelpaper releases under the same MIT licensing model; see LICENSE for legal terms and attribution.

Pixelpaper
## v1.0 (2026-04-19)

*  Performance optimization focus: continued work on faster state transitions (bo firmware reboots between menu switches), background cache, no loadtime between chapters.
*  Background cache
*  No-loading-screen direction: reduced/removed transition loading overlays to keep navigation and startup flow immediate.
*  Reader-first interface flow: prioritized to reading, menu and settigs from reader view. Fewer UI interruptions.
*  Boot/wake sequence polish: refined startup/shutdown animation pacing and corrected duplicate final-title frame behavior.
*  Project continuity updates: documented Pixelpaper lineage and licensing attribution in LICENSE, README, User Guide, and CHANGELOG.
...
*  Rename system directory from .crosspoint to .pixelpaper [[Pavel Liashkov](mailto:pavel.liashkov@protonmail.com)]
...
*  Add UTF-8 filename support and pixelpaper-flasher docs [[Pavel Liashkov](mailto:pavel.liashkov@protonmail.com)]
...
*  Replace boot/sleep logo with Pixelpaper papyrus scroll [[Pavel Liashkov](mailto:pavel.liashkov@protonmail.com)]
